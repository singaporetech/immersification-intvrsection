...
/*
\file TimerWalkAcrossRoadEndZone.cs
\brief Class for checking when the player has reached the end of the crosswalk
*/

public class TimerWalkAcrossRoadEndZone : MonoBehaviour
{
    /*!
